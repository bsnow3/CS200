...
{
	int length = size(first) + size(second) + size(third);
	return length;
}
...
string TranslateWord(string word)
{
	...
	else if (word == "the person") { return "la personon"; }
	else if (word == "the mouse") { return "la muso"; }
	else if (word == "the bird") { return "la birdon"; }
...
string Translate(string subject, string verb, string object)
{
	...
	string phrase = TranslateWord(subject) + " " + TranslateWord(verb) + " " + TranslateWord(object);
